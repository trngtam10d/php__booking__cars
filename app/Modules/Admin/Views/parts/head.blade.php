<head>
    ...
    <link href="{{ asset('public/assets/css/bootstrap-dark.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/assets/css/app-dark.min.css') }}" rel="stylesheet" type="text/css" />
    {{-- lib datatables --}}
    ...
    <link rel="stylesheet" href="{{ asset('public/systems/css/style.css') }}" type="text/css">
</head>
