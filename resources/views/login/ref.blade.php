                                ...
                                <div class="group-icon">
                                    <div class="icon-item">
                                        <a href="{{ url('auth/google')}}">
                                            <img src="../../images/logo-google.png" class="img-fluid img-base"
                                                alt="Google">
                                        </a>
                                    </div>
                                    <div class="icon-item">
                                        <a href="{{url('/getInfo-facebook/facebook')}}">
                                            <img src="../../images/logo-fb.png" class="img-fluid img-base"
                                                alt="Facebook">
                                        </a>
                                    </div>
                                    <div class="icon-item">
                                        <a href="">
                                            <img src="../../images/logo-apple.png" class="img-fluid img-base"
                                    ...
                                    <form action="{{route('registerotp')}}" method="post" class="request-form"
                                        ...
                                        <div class="form-group">
                                            <input  type="text" name="referral_code" class="form-control"
                                              placeholder="Enter referral code if available" value="{{$user->country_code}}" readonly>
                                        </div>
