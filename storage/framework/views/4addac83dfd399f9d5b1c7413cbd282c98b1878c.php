            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-5">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('about')); ?>" class="py-2 d-block">About</a></li>
                        <li><a href="<?php echo e(route('service')); ?>" class="py-2 d-block">Services</a></li>
...
<script src="<?php echo e(asset('ui/js/translate.js')); ?>"></script>
...
<script src="<?php echo e(asset('ui/js/google-map.js')); ?>"></script>
...
<?php echo $__env->yieldPushContent('scripts'); ?><?php /**PATH C:\xampp\htdocs\php__booking\resources\views/partials/footer.blade.php ENDPATH**/ ?>